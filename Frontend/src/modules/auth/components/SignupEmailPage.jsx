        ...
        <div className="block">
            <div className="relative">
                <input
                    ...
                    placeholder={label}
                    className={`w-full rounded-xl border bg-gray-50 px-4 py-3.5 text-base text-volt-deep placeholder:text-volt-deep/40 outline-none transition focus:border-volt focus:bg-white focus:ring-4 focus:ring-volt/15 ${isPassword ? 'pr-11' : ''} ${error ? 'border-red-400' : 'border-volt-deep/10'}`}
                />
                {isPassword && (
                    <button
                        type="button"
